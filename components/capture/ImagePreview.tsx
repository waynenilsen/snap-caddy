...
export function ImagePreview({
  ...
  // Use ref to track pinch distance for native event handlers
  const pinchDistanceRef = useRef<number | null>(null);

  // Touch support for pinch-to-zoom (using native events for preventDefault)
  const handleTouchStart = useCallback(
    ...
    [enableZoom, getDistance],
  );

  const handleTouchMove = useCallback(
    (e: TouchEvent) => {
      if (!enableZoom || pinchDistanceRef.current === null) return;
    ...
    [enableZoom, minZoom, maxZoom, getDistance],
  );
  ...
  // Register native event listeners with passive: false
  useEffect(() => {
