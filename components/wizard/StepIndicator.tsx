...
import { Camera, MousePointer, Ruler, Eye, Settings, Download, Check } from 'lucide-react';
...
const STEPS = [
  { id: 1, title: 'Capture', shortTitle: 'Capture', description: 'Upload or capture image', icon: Camera },
  { id: 2, title: 'Select', shortTitle: 'Select', description: 'Select your object', icon: MousePointer },
  { id: 3, title: 'Calibrate', shortTitle: 'Calibrate', description: 'Set scale with ruler', icon: Ruler },
  { id: 4, title: 'Review', shortTitle: 'Review', description: 'Review outline', icon: Eye },
  { id: 5, title: 'Configure', shortTitle: 'Configure', description: 'Configure bin', icon: Settings },
  { id: 6, title: 'Generate', shortTitle: 'Generate', description: 'Generate STL', icon: Download },
] as const;
...
export function StepIndicator({
  ...
  const getStepStatus = (stepId: number): 'complete' | 'current' | 'upcoming' => {
    if (completedSteps.includes(stepId) && stepId < currentStep) return 'complete';
              ...
              >
                ...
                <div
                  className={cn(
                    ...
                    status === 'upcoming' && 'bg-background border-muted text-muted-foreground',
