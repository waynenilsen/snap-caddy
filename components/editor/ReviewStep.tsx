  ...
  const handleConfirm = () => {
    try {
      ...
      if (!svgContent || svgContent.trim().length === 0) {
        setError(
          "No SVG content available. Please go back and complete the previous steps.",
        );
        return;
      }
      ...
      setError(
        "An error occurred while processing the SVG. Please try adjusting the padding or go back to the previous step.",
      );
    }
  };
