...
describe('SnapCaddyAPI', () => {
  ...
  describe('segment', () => {
    ...
    it('should handle optional returnMultipleMasks parameter', async () => {
      const mockResponse: SegmentResponse = {
        masks: [{ data: 'mask-data', score: 0.9 }],
      };
  ...
  describe('getGenerationStatus', () => {
    ...
    it('should handle complete status with stlData', async () => {
      const mockResponse: GenerationStatusResponse = {
        status: 'complete',
        stlData: 'base64-stl',
      };
      ...
      expect(result.stlData).toBe('base64-stl');
    });
